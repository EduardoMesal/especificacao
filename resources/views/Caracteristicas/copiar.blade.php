                            ...
                            <div class="flex-column">
                                <form class="form responseAjax" method="POST" action="{{route('Caracteristicas.criar_action')}}" novalidate enctype="multipart/form-data">
                                    ...
                                    <div class="mb-5 text-center d-flex justify-content-between align-items-center">
                                        <h1 class="">Copiar característica</h1>
                                    ...
                                    <div class="row g-9 mb-8">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" value="{{ optional($caracteristica->caracteristicasIdiomas->first())->nome }}" class="form-control form-control-solid" placeholder="Preencha o campo nome" name="nome" />
                                        </div>
                                    ...
                                    <div class="col-md-12 fv-row obsTexto mb-8" style="{{ $caracteristica->tipo != 'texto' ? 'display:none' : '' }}">
                                        ...
                                        <input type="text" value="{{optional($caracteristica->atributos->first()->atributosIdiomas->first())->observacao}}" class="form-control form-control-solid obsTextoInput" placeholder="Preencha o campo observação" name="observacao" />
                                    </div>
