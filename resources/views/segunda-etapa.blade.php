...
<body id="kt_body" class="bg-body">
	<div class="d-flex flex-column flex-root">
		<div class="bg-auth d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed">
			<div class="d-flex flex-center flex-column flex-column-fluid p-10">
				<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
					<form class="form w-100" method="POST" action="{{ route('segunda-etapa.verify') }}">
						@csrf
						...
						<div class="fv-row mb-10">
							...
							<p class="text-muted">Digite o código de validação enviado para o seu e-mail.</p>
							<input id="code" value="{{ old('code') }}" class="form-control form-control-lg form-control-solid" type="text" name="code" />
						</div>
