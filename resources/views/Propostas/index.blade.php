                        ...
                        <div class="card card-flush h-xl-100">
                            <div class="card-body pt-3 pb-4">
                                <div class="table-responsive">
                                        ...
                                        <tbody id="contentSortableSecoes">
                                            ...
                                            <tr data-key="{{$item->id}}" class="draggableTr" data-ordem="{{ $item->id }}">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="{{route('Propostas.editar', ['id' => $item->id])}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{!! $item->nome !!}</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="text-end">
                                                    <div class="adjustBtnsUser gap-5">
                                                        <a href="{{route('Propostas.editar', ['id' => $item->id])}}" class="btn btn-sm btn btn-primary"><i class="bi bi-pencil-fill"></i> Editar
                                                        </a>
                                                        <form class="responseAjax" action="{{route('Propostas.excluir', ['id' => $item->id])}}" method="post">
                                                            @csrf
                                    ...
                                    @else
                                    <p>Nenhuma proposta foi encontrada!</p>
                                    @endif
                                    <div class="contentPaginate mt-5 mb-5" style="margin: 0px;">
                                        {{ $propostas->links('vendor.pagination.custom') }}
                                    </div>
                                </div>
                            </div>
                        </div>
