                                    ...
                                    <form class="form responseAjax" method="POST" action="{{route('Especificacoes.editar', ['id' => $especificacao->id])}}" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="row g-9 mb-8">
                                                    ...
                                                    <div class="mb-8 row fv-row selectArea input-style-1">
                                                        ...
                                                        @elseif ($c->tipo == 'multiplos')
                                                            <label class="d-flex fs-6 fw-bold d-flex justify-content-between">
                                                                <div class="d-flex gap-2 align-items-center">
                                                                    <span class="mb-3">{!! optional($c->caracteristicasIdiomas->first())->nome !!}</span> 
                                                                    @if(optional($c->caracteristicasIdiomas->first())->unidade)
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            class="bg-transparent textAtributo" placeholder="Preencha o campo texto" name="caracteristicas[{{ $c->id }}][atributo_texto][conteudo]" />
                                                            <input type="hidden" name="caracteristicas[{{ $c->id }}][caracteristica_id]" value="{{ $c->id }}" />
                                            ...
                                            <div id="att">
                                                ...
                                                @if(count($especificacao->maquina->imagens) > 0)
                                                <div class="col-md-12 fv-row selectArea input-style-1" style="margin-top: 30px;">
                                                    <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                        <span class="mb-2">Imagem</span>
                                                    </label>
                                                    <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('.custom-control-input').on('change', function () {
            if ($(this).is(':checked')) {
                ...
                $(this).closest('.card-style').addClass('activeImage');
            } else {
