                            ...
                            <div class="flex-column">
                                <form class="form responseAjax" method="POST" action="{{route('Especificacoes.criar_action', ['id' => $maquina->id])}}" novalidate enctype="multipart/form-data">
                                    ...
                                    <div class="mb-5 text-center">
                                        <h1 class="">Crie sua especificação</h1>
                                    </div>
                                    <div class="row g-9 mb-8">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" disabled class="form-control form-control-solid" value="{{ optional($maquina->maquinasIdiomas->first())->nome }}"/>
                                        </div>
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" name="codigo_focco" class="form-control form-control-solid" value=""/>
                                        </div>
                                        <div class="col-md-6 fv-row">
                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                <span class="">Série</span>
                                            </label>
                                            <input type="text" name="serie" class="form-control form-control-solid" value=""/>
                                        </div>
                                        ...
                                        <div class="col-md-12 fv-row">
                                            @foreach($maquina->caracteristicas as $index => $c)
                                                <div class="mb-8 fv-row row selectArea">
                                                    ...
                                                    @elseif ($c->tipo == 'multiplos')
                                                        ...
                                                        @foreach($c->atributos as $a)
                                                            ...
                                                            <div class="col-md-6 mt-5 mt-md-8">
                                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                                    <span class="">Observações</span>
                                                                </label>
                                                                <input type="text" class="form-control form-control-solid"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid mt-2" placeholder="Preencha o campo texto" name="caracteristicas[{{ $c->id }}][atributo_texto][conteudo]" />
                                                        <input type="hidden" name="caracteristicas[{{ $c->id }}][caracteristica_id]" value="{{ $c->id }}" />
