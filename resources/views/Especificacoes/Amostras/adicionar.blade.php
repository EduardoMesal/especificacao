                        ...
                        <div class="flex-grow-1">
                            <div class="justify-content-between align-items-start flex-wrap mb-2">
                                <div class="flex-column">
                                    <form class="form responseAjax" method="POST" action="{{route('Especificacoes.criar_amostra_action', ['especificacaoId' => $especificacaoId, 'id' => $amostra->id])}}" novalidate enctype="multipart/form-data">
                                        @csrf
