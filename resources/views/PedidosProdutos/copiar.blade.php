                            ...
                            <div class="justify-content-between align-items-start flex-wrap mb-2">
                                <div class="flex-column">
                                    <form class="form responseAjax" method="POST" action="{{route('PedidosProdutos.criar_action', ['id' => $produto->id])}}" novalidate enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="produtoIndicePedidoId" value="{{$atributoProdutoPedido['id']}}">
                                                                                ...
                                                                                <div class="col-md-6 col-xxl-3 mb-5 projectContent" id="img-{{ $item->id }}">
                                                                                    <div class="card adjustCardUsers">
                                                                                        <div class="card-body d-flex flex-center flex-column " style="background-color: #f5f8fa;">
                                                                                            <img class="imgProject" src="{{ mixAssets('assets/img/produtoss/atributos/pedido/' . $item->imagem) }}"/>
                                        ...
                                        <div class="col-md-4 col-xxl-3 mb-4 projectContent">
                                            <div class="card-style">
                                                <div class="card-body d-flex flex-center flex-column">
                                                    ...
                                                    <a
                                                        href="{{ mixAssets('assets/img/produtos/pedido/' . $item['arquivo']) }}"
                                                        class="light-item"
                                                        data-sub-html="Imagem {{ $key + 1 }}">
                                                        <img
                                                            class="imgProject img-fluid"
                                                            src="{{ mixAssets('assets/img/produtos/pedido/' . $item['arquivo']) }}" />
                                                    </a>
                ...
                <div class="card-style">
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                        <div class="flex-grow-1">
                            ...
                            <div class="schedules-area pt-7 imgsAmostra">
                                <div class="row" id="contentSortableProjects">
                                    @if(count($atributoProdutoPedido['documentos']) > 0)
                                        <div class="table-wrapper table-responsive">
                                            <table class="table striped-table">
                                                ...
                                                @foreach ($atributoProdutoPedido['documentos'] as $key => $item)
                                                    <tbody>
                                                        <tr style="padding: 15px !important;">
                                                            <td>
                                                                <a target="_blank" href="{{ mixAssets('assets/img/produtos/pedido/' . $item['arquivo']) }}">
                                                                {{$item['arquivo']}}
                                                                </a>
                                                            </td>
                                                        </tr>
...
<script>
    ...
    document.querySelectorAll('.filepondAjax').forEach((input) => {
        ...
        FilePond.create(input, {
            ...
            server: {
                process: {
                    url: '/pedidos-produtos/upload-atributo-imagens',
                    method: 'POST',
                    headers: {
    ...
    $(document).on('click', '.btn-delete-imagem', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `/pedidos-produtos/excluir-atributo-imagem/${imagemId}`,
                    type: 'POST',
                    headers: {
