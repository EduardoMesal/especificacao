                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                ...
                                <tr data-href="{{route('PedidosProdutos.criar', ['id' => $item->id])}}">
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <div style="min-width: 180px">
                                            <a href="{{route('PedidosProdutos.criar', ['id' => $item->id])}}" class="btn btn-sm btn btn-primary mw-100"><i class="bi bi-plus"></i> Criar especificação
                                            </a>
                                        </div>
                                    </td>
                                </tr>
