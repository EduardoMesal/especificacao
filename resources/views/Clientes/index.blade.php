                    ...
                    <div class="table-responsive">
                        <div class="card-header" style="padding: .5rem 0px; border-bottom:0px">
                            <div class="mb-30 d-flex align-items-center justify-content-between w-100">
                                <h6 class="text-medium">Clientes</h6>
                                    ...
                                    <div class="hidden modal-options-menu" data-modal="modalOpenFilter">
                                        <ul class="modal-options">
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{route('Clientes.index')}}" class="text-danger">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                ...
                                <tr data-href="{{route('Clientes.editar', ['id' => $item->id])}}">
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <div style="position: relative">
                                            ...
                                            <div class="hidden modal-options-menu" data-modal="modalOpenFilterEspcificacoes{{$item->id}}">
                                                <ul class="modal-options">
                                                    <li class="dropdown-item">
                                                        <a class="link-modal" href="{{route('Clientes.editar', ['id' => $item->id])}}"> <i class="bi bi-pencil"></i> Editar
                                                        </a>
                                                    </li>
                                                    <li class="dropdown-item">
                                                        <form class="responseAjax" action="{{route('Clientes.excluir', ['id' => $item->id])}}" method="post">
                                                            @csrf
