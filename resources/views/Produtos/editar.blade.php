                                    ...
                                    <form class="form responseAjax" method="POST" action="{{route('Produtos.editar_action', ['id' => $produto->id, 'lang' => request('lang')])}}" novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="row g-9 mb-8">
                                            <div class="col-md-12 fv-row input-style-1">
                                                ...
                                                <input type="text" value="{{ optional($produto->produtosIdiomas->first())->nome }}"  class="bg-transparent" placeholder="Preencha o campo nome" name="nome" />
                                            </div>
                                        </div>
                            ...
                            <div class="hidden modal-options-menu" data-modal="modalOpenFilter">
                                <ul class="modal-options">
                                    <li class="dropdown-item">
                                        <a href="{{route('Produtos.criar_atributo', ['id' => $produto->id])}}" class="link-modal">
                    ...
                    <div class="table-wrapper table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr data-href="{{route('Produtos.editar_atributo', ['id' => $item->id])}}">
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <div>
                                            ...
                                            <div class="hidden modal-options-menu" data-modal="modalOpenFilterAmostra{{$item->id}}">
                                                <ul class="modal-options">
                                                    <li class="dropdown-item">
                                                        <a class="link-modal" href="{{route('Produtos.editar_atributo', ['id' => $item->id])}}"> <i class="bi bi-pencil"></i> Editar
                                                        </a>
                                                    </li>
                                                    <li class="dropdown-item">
