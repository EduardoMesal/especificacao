                        ...
                        <div class="table-responsive">
                            <div class="card-header mt-5" style="padding: .5rem 0px; border-bottom:0px">
                                <div class="card-title flex-column">
                                    <div class="fs-6 text-gray-800 mb-2">Produtos</div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="adjustBtnsUser gap-5">
                                                <a style="min-width: 128px" href="{{route('Produtos.criar_atributo', ['id' => $item->id])}}" class="btn btn-sm btn btn-primary"><i class="bi bi-plus"></i> Criar atributos
                                                </a>
                                                <a href="{{route('Produtos.editar', ['id' => $item->id])}}" class="btn btn-sm btn btn-primary"><i class="bi bi-pencil-fill"></i> Editar
                                                </a>
