            ...
            <div class="col-xl-12">
                <div class="card-style">
                    <div class="mb-30 d-flex align-items-center justify-content-between w-100">
                        <h6 class="text-medium">Produtos</h6>
                            ...
                            <div class="hidden modal-options-menu" data-modal="modalOpenFilter">
                                <ul class="modal-options">
                                    ...
                                    <li class="dropdown-item">
                                        <a href="{{route('Produtos.index')}}" class="text-danger">
                        ...
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                           <thead>
                            ...
                            <tbody>
                                ...
                                <tr data-href="{{route('Produtos.editar', ['id' => $item->id])}}">
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <div style="position: relative">
                                            ...
                                            <div class="hidden modal-options-menu" data-modal="modalOpenFilterEspcificacoes{{$item->id}}">
                                                <ul class="modal-options">
                                                    <li class="dropdown-item">
                                                        <a class="link-modal" href="{{route('Produtos.criar_atributo', ['id' => $item->id])}}">  <i class="bi bi-plus"></i> Criar atributos
                                                        </a>
                                                    </li>
                                                    <li class="dropdown-item">
                                                        <a class="link-modal" href="{{route('Produtos.editar', ['id' => $item->id])}}"> <i class="bi bi-pencil"></i> Editar
                                                        </a>
                                                    </li>
                                                    <li class="dropdown-item">
                                                        <form class="responseAjax" action="{{route('Produtos.excluir', ['id' => $item->id])}}" method="post">
                                                            @csrf
