                ...
                <div class="card-style">
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                        <div class="flex-grow-1">
                            <div class="justify-content-between align-items-start flex-wrap">
                                <div class="flex-column">
                                    <form class="form responseAjax" method="POST" action="{{route('Usuario.perfil_action')}}" novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-13 text-center">
                                            <h2 class="mb-3">Editar seu perfil</h2>
                                        </div>
                                        <div class="row imgArea my-5">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="fileupload-new thumbnail" data-kt-image-input="true">
                                                    <div class="bgCropper">
                                                        <img id="image-preview" src="{{ mixAssets('assets/img/users/' . $usuario->avatar) }}" style=" max-width: 180px; " alt="">
                                        ...
                                        <div class="row">
                                            <div class="d-flex flex-column col-md-6 mb-8 fv-row input-style-1">
                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                    <span class="required">Nome</span>
                                                </label>
                                                <input value="{{ old('nome', $usuario->nome) }}" type="text" class="bg-transparent" placeholder="Preencha o campo nome" name="nome" />
                                            </div>
                                            <div class="d-flex col-md-6 flex-column mb-8 fv-row input-style-1">
                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                    <span class="required">E-mail</span>
                                                </label>
                                                <input value="{{ old('email', $usuario->email) }}" type="email" class="bg-transparent" disabled placeholder="Preencha o campo e-mail" name="email" />
                                            </div>
                                        </div>
                                        <div class="row g-9 mb-8">
                                            <div class="col-md-6 fv-row input-style-1">
                                                ...
                                                <input type="password" class="bg-transparent" placeholder="Preencha o campo senha" name="password" />
                                            </div>
                                            <div class="col-md-6 fv-row input-style-1">
                                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                    <span class="required">Confirmar senha</span>
                                                </label>
                                                <input type="password" class="bg-transparent" placeholder="Preencha o campo confirmar senha" name="password_confirmation" />
                                            </div>
                                        </div>
...
<script>
   $(document).ready(function() {
        ...
        const photo = @json($usuario->avatar);
        const defaultImage = "{{ asset('assets/img/users/') }}" + '/'+photo;
