                                ...
                                <form class="form responseAjax" method="POST" action="{{route('Amostras.editar_atributo_action', ['id' => $atributo->id, 'lang' => request('lang')])}}" novalidate enctype="multipart/form-data">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" value="{{optional($atributo->atributosAmostrasIdiomas->first())->nome}}" list="list-input" id="input-datalist" class="form-control form-control-solid" placeholder="Preencha o campo nome" name="nome" />
                                    ...
                                    <div class="col-md-12 fv-row obsTexto mb-8" style="{{ $atributo->tipo != 'texto' ? 'display:none' : '' }}">
                                        ...
                                        <input type="text" value="{{optional($atributo->subAtributos->first()->subAtributosAmostrasIdiomas->first())->observacao}}" class="form-control form-control-solid" placeholder="Preencha o campo observação" name="observacao" />
                                    </div>
                                                        ...
                                                        <div data-repeater-item>
                                                            ...
                                                            <div class="form-group row mb-5">
                                                                <div class="col-md-6 mb-md-0 mb-5">
                                                                    ...
                                                                    <input name="att[{{ $loop->index }}][atributo]" class="form-control form-control-solid" type="text" placeholder="Atributo" value="{{ $atributo->tipo != 'texto' ? optional($att->subAtributosAmostrasIdiomas->first())->nome : '' }}" />
                                                                </div>
                                                                <div class="col-md-6 mt-md-0 mt-5">
                                                                    <label class="form-label">Observação</label>
                                                                    <input name="att[{{ $loop->index }}][observacao]" class="form-control form-control-solid" type="text" placeholder="Observação" value="{{ $atributo->tipo != 'texto' ? optional($att->subAtributosAmostrasIdiomas->first())->observacao : '' }}" />
                                                                </div>
                                                                <div>
