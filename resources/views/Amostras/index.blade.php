                                ...
                                <div class="hidden modal-options-menu" data-modal="modalOpenFilter">
                                    <ul class="modal-options">
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{route('Amostras.index')}}" class="text-danger">
                    ...
                    <div class="table-responsive">
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                ...
                                <tr data-href="{{route('Amostras.editar', ['id' => $item->id])}}">
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex justify-content-start flex-column">
                                                <span 
                                                    class="text-gray-800 text-hover-primary mb-1 fs-6 limite-texto" 
                                                    data-bs-toggle="tooltip"
                                                    data-bs-placement="top"
                                                    data-bs-custom-class="custom-tooltip"
                                                    data-bs-title="{{ optional($item->amostrasIdiomas[0])->nome }}"
                                                    style="width: 300px">
                                    ...
                                    <td class="text-end">
                                        <div>
                                            ...
                                            <div class="hidden modal-options-menu" data-modal="modalOpenFilterEspcificacoes{{$item->id}}">
                                                <ul class="modal-options">
                                                    <li class="dropdown-item">
                                                        <a href="{{route('Amostras.criar_atributo', ['id' => $item->id])}}" class="link-modal"><i class="bi bi-plus"></i> Criar atributos
                                                        </a>
                                                    </li>
                                                    <li class="dropdown-item">
                                                        <a class="link-modal" href="{{route('Amostras.editar', ['id' => $item->id])}}"> <i class="bi bi-pencil"></i> Editar
                                                        </a>
                                                    </li>
                                                    <li class="dropdown-item">
                                                        <form class="responseAjax" action="{{route('Amostras.excluir', ['id' => $item->id])}}" method="post">
                                                            @csrf
