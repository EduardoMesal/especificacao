                        ...
                        <div class="table-responsive">
                            <div class="card-header mt-5" style="padding: .5rem 0px; border-bottom:0px">
                                <div class="card-title flex-column">
                                    <div class="fs-6 text-gray-800 mb-2">Amostras</div>
                                </div>
                                <div class="d-flex gap-5 btnsAside">
                                    <button class="btn btn-primary openSide">
                                        <i class="bi bi-filter"></i> Filtrar
                                    </button>
                                    <a href="{{route('Amostras.index')}}" class="btn btn-danger">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="adjustBtnsUser gap-5">
                                                <a style="min-width: 128px" href="{{route('Amostras.criar_atributo', ['id' => $item->id])}}" class="btn btn-sm btn btn-primary"><i class="bi bi-plus"></i> Criar atributos
                                                </a>
                                                <a href="{{route('Amostras.editar', ['id' => $item->id])}}" class="btn btn-sm btn btn-primary"><i class="bi bi-pencil-fill"></i> Editar
                                                </a>
