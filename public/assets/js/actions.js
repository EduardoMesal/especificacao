var page_actions = function () {
  ...
  /* MESSAGE BOX */
  $(document).on("click", ".mb-control", function (event) {
...
function x_navigation() {
  ...
  $(".x-navigation li").click(function (event) {
    if (!$(event.target).closest(".mb-control").length) {
      ...
      if (
        ...
        if ($(this).hasClass("xn-profile").length > 0) return true;
        else return false;
      }
    }
  });
...
$(window).scroll(function () {
  if ($(this).scrollTop() > 10) {
    $(".page-container .page-sidebar").addClass("contentMenuUp");
  } else {
    $(".page-container .page-sidebar").removeClass("contentMenuUp");
  }
});
wskCheckbox.init();
/* ./MATERIAL CHECKBOX */
