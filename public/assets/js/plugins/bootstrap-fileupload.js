...
+function ($) { "use strict";
  ...
  var Fileupload = function (element, options) {
    ...
    this.bkp = this.$element.find('.fileupload-filename').html();
  ...
  Fileupload.prototype.listen = function() {
    ...
    this.$element.find('.fileupload-remove').on('click.bs.fileupload', $.proxy(this.clear, this))
  },
  ...
  Fileupload.prototype.change = function(e) {
    ...
    if (this.$preview.length > 0 && (typeof file.type !== "undefined" ? (file.type.toLowerCase()).match(/^image\/(gif|png|jpeg)$/) : (file.name.toLowerCase()).match(/\.(gif|png|jpe?g)$/i)) && typeof FileReader !== "undefined") {
      var reader = new FileReader()
      var preview = this.$preview
      var element = this.$element

      reader.onload = function(re) {
        // var $img = $('<img id="fileupload-image-preview">')
        var $img = $('<img>')
  ...
  Fileupload.prototype.clear = function(e) {
    ...
    this.$element.find('.fileupload-filename').html(typeof this.bkp != 'undefined'?this.bkp:'');
